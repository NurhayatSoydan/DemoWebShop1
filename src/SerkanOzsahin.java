...
public class SerkanOzsahin extends BaseDriver {
    ...
    @Test
    public void KullaniciHesabiOlustur() {
        ...
        System.out.println("\u001B[94mKullaniciHesabiOlustur = \u001B[0m" + "\u001B[32m" + "Hesap bilgileri başarılı bir şekilde girildi." + "\u001B[0m");
        System.out.println("\u001B[94mKullaniciHesabiOlustur = \u001B[0m" + "\u001B[32m" + "Hesap başarıyla oluşturuldu." + "\u001B[0m");
        System.out.println("\u001B[94mKullaniciHesabiOlustur = \u001B[0m" + "\u001B[32m" + "Hesap açma işlemi başarıyla bitirildi mesajı ekrana geldi." + "\u001B[0m");
